...
const CITATIONS: Record<CitationId, Citation> = {
  ...
  rescues2008: {
    ...
    quote: [
      'Nonetheless, the Federal Reserve intervened to support some of these institutions, motivated by a desire to avert disorderly failures that could have harmed the US economy more broadly. Bear Stearns, an investment bank, was acquired by JPMorgan Chase (JPMC) in the spring of 2008 in a transaction that was assisted by the Federal Reserve Bank of New York (FRBNY). … Lehman Brothers, an investment bank, filed for bankruptcy on September 15, 2008. The next day, AIG, a large insurance and financial services company received support from the FRBNY.',
    ],
  },
  negativeEquity: {
    source: 'Sarah Bell et al.',
    title: 'Why are central banks reporting losses? Does it matter?',
    detail: 'BIS Bulletin, no. 68, 2023, pp. 1 and 5',
    ...
    quote: [
      ...
      'Several central banks had negative equity yet fully met their objectives – for example, the central banks of Chile, Czechia, Israel and Mexico experienced years of negative capital.',
    ],
  },
  volckerRates: {
  ...
  keynes: {
    ...
    detail: 'Harcourt, Brace and Howe, 1920, chapters V and VII',
  ...
  mod97: {
    ...
    quote: [
      'The check character systems specified in ISO/IEC 7064:2002 can detect: all single substitution errors (the substitution of a single character for another, for example 4234 for 1234)…',
    ],
  },
  svbOrder: {
  ...
  promptCorrective: {
    ...
    quote: [
      ...
      'Within 90 days after an IDI becomes critically undercapitalized, the appropriate FBA must take one of the following actions: Appoint a receiver (or, with FDIC concurrence, appoint a conservator) for the IDI, or Take such other action as the agency determines, with the concurrence of the FDIC, would better achieve the purposes of Section 38…',
    ],
  },
  ccyb: {
    source: 'Czech National Bank',

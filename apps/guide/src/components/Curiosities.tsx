  ...
  ledgersFirst: {
    ...
    body: (
      <>
        ...
        <p>
          The ledger came first. The oldest writing we have was invented for
          accounting: Mesopotamian clay tablets counting and recording goods
  ...
  recordsAsAlarm: {
    ...
    body: (
      <>
        ...
        <p>
          Real banks add one more layer: rules require them to monitor, from
          their own records, the running net balance of all payments made and
          received over their account at the central bank.
          <Cite id="intradayLiquidity" /> This world keeps the rule at its
          smallest — ask what you can ask, write down what you were told, and
          let the balance sheet be the alarm.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <p>
          ...
          failing banks — the central banks by lending them freshly created
          money — rather than let the losses fall through to everyone's
          accounts.
          <Cite id="rescues2008" />
        </p>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          -0.5% a year: borrow 100, and a year later you owe 99.5 — before the
          bank's fees, which still left the total cost a shade above zero.
          <Cite id="jyskeMortgage" /> The bank was not the one losing — in
          Denmark, mortgage money comes from investors, pension funds among
          them; the bank passes the borrower's repayments through to them and
    ...
    body: (
      <>
        <p>
          ...
          <Cite id="fedZeroReserves" />; Britain and Canada run without one
          entirely.
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            roughly 8 CZK must be the bank's own capital, with the equity you
            watched absorb a write-off at its core (the international floor: 8%)
            <Cite id="baselCapital" />
          </li>
        </ul>
        <p>
  ...
  onUsPayments: {
    ...
    body: (
      <>
        ...
        <p>
          The database world can even take over from cash. When Greece limited
          cash withdrawals in 2015, card payments surged
          <Cite id="greeceCards" /> — everyday commerce kept running as payments
          moved inside the banks' databases.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        <p>
          ...
          fails the check
          <Cite id="mod97" /> — so the payment is refused instead of sent to a
          stranger.
        </p>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          commercial banks failed this way, and over a third of the country's
          money vanished in less than four years.
